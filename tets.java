...
public class Robot extends TimedRobot {
    ...
    private static final double Kp=2.6;
    private static final double Ki=0.0036; // .01 * P
    private static final double Kf=0.0;  //no feed-forward on positon control
    private static final double Kd=340;
    ...
    TalonSRX _motor = new TalonSRX(6);
    /**
    ...
    public void robotInit() {
         ...
         * (controlled) loop
         */
        _motor.configOpenloopRamp(0.2, 0);
        _motor.configClosedloopRamp(0.2, 0);
